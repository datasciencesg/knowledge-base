...
def updateHand(hand, word):
    ...
    # for each char in the word, reduce the value of corresponding char in the 
    #current hand by 1
    for char in word:
        current_hand[char] -= 1
    return current_hand
...
def isValidWord(word, hand, wordList):
    ...
    # checks if the word is in the word_list
    if word in wordList:
...
def calculateHandlen(hand):
    ...
    returns: integer
    """
    # initialize hand_length to be 0
    hand_length = 0
    
    # get a list of keys in hand
    hand_keys = hand.keys()
    
    # for each key in hand, add the corresponding value to hand_length
